...
public class FunctionInterfaceEx1 {
	...
	public static void main(String[] args) {
		...
		print(list, s-> {
			System.out.println(s.getName() + ": 국어 - " + 
					s.getKor() + ", 영어 - " +
					s.getEng() + ", 수학 - " + s.getMath());
		});
		...
		System.out.println("==============");
		//국어 성적이 50점이상인 학생들의 정보를 출력
		printStudent(list, s -> s.getKor() >= 60);
		System.out.println("==============");
		//평균이85점이상인 학생들의 정보를 출력
		printStudent(list, s -> 
	...
	//총점
	public static void printTotalScore(List<Student> list,
											Function<Student, Integer> fn) {
		int total = 0;
