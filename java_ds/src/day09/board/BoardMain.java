...
public class BoardMain {
	...
	private static int count = 0; //현재 등록 된 게시글 개수
	...
	private static void runSubmenu(int submenu) {
		...
		case 1:
			...
			//반복문 : 등록된 게시글 전체, 배열 전체X
				for(int i = 0; i < count; i++) {
				//입력한 번호와 같은 번호를 가진 게시글 찾기
		...
		case 2:
			...
			System.out.println("수정 할 게시글의 번호를 입력하세요 : ");
			//수정할 게시글 번호와 제목, 내용을 입력
			int num = scan.nextInt();
			
			scan.nextLine();
			System.out.print("수정 할 게시글의 제목을 입력하세요 : ");
			String title = scan.nextLine();
			
			scan.nextLine();
			System.out.print("수정 할 게시글의 내용을 입력하세요 : ");
	...
	private static void insertBoard() {
		...
		System.out.print("제목 : ");
		String title = scan.nextLine(); //공포
		System.out.print("내용 : ");
		String contents = scan.nextLine();
		System.out.print("일자 : ");
		String date = scan.next(); //공미포
